...
def main():
    ...
    ## Main options
    ##
    parser.add_option("--compute-gene-psi",
                      dest="compute_gene_psi",
                      nargs=4,
                      default=None,
    ...
    ## Psi utilities
    ##
    parser.add_option("--compare-samples",
                      dest="samples_to_compare",
                      nargs=3,
                      default=None,
    ...
    parser.add_option("--comparison-labels",
                      ...
                      "to --compare-samples.")
    parser.add_option("--summarize-samples",
                      dest="summarize_samples",
                      nargs=2,
                      default=None,
    ...
    parser.add_option("--summary-label",
                      dest="summary_label",
                      nargs=1,
                      default=None,
    ...
    if options.summarize_samples:
        ...
        summary_filename = os.path.join(summary_output_dir, '%s.miso_summary' %
                                        (samples_label))
        summarize_sampler_results(samples_dir,
                                  summary_filename,
                                  use_compressed=use_compressed)
